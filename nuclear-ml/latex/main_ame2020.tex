...
我们使用AME2020（Atomic Mass Evaluation 2020）数据库中的实验结合能数据。
数据集构建流程如下：
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lcccc}
    ...
    \midrule
    SEMF & 全核图 & $\sim$2.5 & 解析公式 & Weizsäcker 1935 \\
    FRDM & 全核图 & 0.58 & 宏观-微观 & Möller+ 2016 \\
    WS4 & 全核图 & 0.35 & 宏观-微观 & Wang+ 2014 \\
    \midrule
    BNN & 2353核 & 0.20 & 贝叶斯神经网络 & Niu+ 2018 \\
    KRNM & 2457核 & 0.14 & 核回归 & Utama+ 2016 \\
    \midrule
...
完整的实验代码和数据集已开源：
\begin{itemize}
  \item 代码仓库: \texttt{github.com/username/nuclear-ml}
